...
def conversion_all_sample(speaker_name_list, wav_list, model_dir, model_name, data_dir, output_dir):
...
if __name__ == '__main__':
    ...
    wav_list_default = ['200001.wav', '200002.wav', '200003.wav']
    ...
    parser.add_argument('--wav_list', type = str, nargs='+', help = 'Wav Filelist.', default = wav_list_default)
    ...
    wav_list = argv.wav_list
    model_dir = argv.model_dir
    model_name = argv.model_name
    data_dir = argv.data_dir
    output_dir = argv.output_dir

    conversion_all_sample(speaker_name_list = speaker_name_list, wav_list = wav_list, model_dir = model_dir, model_name = model_name, data_dir = data_dir, output_dir = output_dir)
